<?php echo form_open('tarif_master/add',array("class"=>"form-horizontal")); ?>

	<div class="form-group">
		<label for="tipe_perawatan" class="col-md-4 control-label">Tipe Perawatan</label>
		<div class="col-md-8">
			<input type="text" name="tipe_perawatan" value="<?php echo $this->input->post('tipe_perawatan'); ?>" class="form-control" id="tipe_perawatan" />
		</div>
	</div>
	<div class="form-group">
