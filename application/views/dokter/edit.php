<?php echo form_open('dokter/edit/'.$dokter['kd_dokter'],array("class"=>"form-horizontal")); ?>
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<input type="text" name="almt_tgl" value="<?php echo ($this->input->post('almt_tgl') ? $this->input->post('almt_tgl') : $dokter['almt_tgl']); ?>" class="form-control" id="almt_tgl" />
		</div>
	</div>
	<div class="form-group">
		<label for="no_telp" class="col-md-4 control-label">No Telp</label>
		<div class="col-md-8">
			<input type="text" name="no_telp" value="<?php echo ($this->input->post('no_telp') ? $this->input->post('no_telp') : $dokter['no_telp']); ?>" class="form-control" id="no_telp" />
		</div>
	</div>
	<div class="form-group">
		<label for="stts_nikah" class="col-md-4 control-label">Stts Nikah</label>
		<div class="col-md-8">
			<input type="text" name="stts_nikah" value="<?php echo ($this->input->post('stts_nikah') ? $this->input->post('stts_nikah') : $dokter['stts_nikah']); ?>" class="form-control" id="stts_nikah" />
		</div>
	</div>
	<div class="form-group">
		<label for="kd_sps" class="col-md-4 control-label">Kd Sps</label>
		<div class="col-md-8">
			<input type="text" name="kd_sps" value="<?php echo ($this->input->post('kd_sps') ? $this->input->post('kd_sps') : $dokter['kd_sps']); ?>" class="form-control" id="kd_sps" />
		</div>
	</div>
	<div class="form-group">
		<label for="alumni" class="col-md-4 control-label">Alumni</label>
		<div class="col-md-8">
			<input type="text" name="alumni" value="<?php echo ($this->input->post('alumni') ? $this->input->post('alumni') : $dokter['alumni']); ?>" class="form-control" id="alumni" />
		</div>
	</div>
	<div class="form-group">
		<label for="no_ijn_praktek" class="col-md-4 control-label">No Ijn Praktek</label>
		<div class="col-md-8">
			<input type="text" name="no_ijn_praktek" value="<?php echo ($this->input->post('no_ijn_praktek') ? $this->input->post('no_ijn_praktek') : $dokter['no_ijn_praktek']); ?>" class="form-control" id="no_ijn_praktek" />
		</div>
	</div>
	<div class="form-group">
		<label for="status" class="col-md-4 control-label">Status</label>
		<div class="col-md-8">
			<input type="text" name="status" value="<?php echo ($this->input->post('status') ? $this->input->post('status') : $dokter['status']); ?>" class="form-control" id="status" />
		</div>
	</div>
